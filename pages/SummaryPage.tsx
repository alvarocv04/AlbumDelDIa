                            ...
                            <div className="mb-16">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 px-4">
                                    <div className="flex flex-col gap-3 rounded-2xl p-6 bg-white dark:bg-surface-dark border border-gray-200 dark:border-[#3b4354] shadow-sm hover:border-primary transition-colors group">
                                        <div className="flex justify-between items-start"><div className="p-2 bg-primary/10 rounded-full text-primary group-hover:bg-primary group-hover:text-white transition-colors"><span className="material-symbols-outlined">schedule</span></div><span className="text-accent-green text-sm font-bold bg-accent-green/10 px-2 py-1 rounded-full">+12% vs 2022</span></div>
                                        <div><p className="text-gray-500 dark:text-text-secondary text-sm font-medium uppercase tracking-wider">{t('home.total_minutes')}</p><p className="text-gray-900 dark:text-white text-4xl font-black tracking-tight mt-1">34,200</p></div>
                                    </div>
                                        <div className="flex flex-col gap-3 rounded-2xl p-6 bg-white dark:bg-surface-dark border border-gray-200 dark:border-[#3b4354] shadow-sm hover:border-primary transition-colors group">
                                        <div className="flex justify-between items-start"><div className="p-2 bg-primary/10 rounded-full text-primary group-hover:bg-primary group-hover:text-white transition-colors"><span className="material-symbols-outlined">album</span></div><span className="text-accent-green text-sm font-bold bg-accent-green/10 px-2 py-1 rounded-full">+5% vs 2022</span></div>
                                        <div><p className="text-gray-500 dark:text-text-secondary text-sm font-medium uppercase tracking-wider">{t('summary.new_albums')}</p><p className="text-gray-900 dark:text-white text-4xl font-black tracking-tight mt-1">120</p></div>
                                    </div>
                                        <div className="flex flex-col gap-3 rounded-2xl p-6 bg-white dark:bg-surface-dark border border-gray-200 dark:border-[#3b4354] shadow-sm hover:border-primary transition-colors group">
                                        ...
                                        <div><p className="text-gray-500 dark:text-text-secondary text-sm font-medium uppercase tracking-wider">{t('summary.top_genre')}</p><p className="text-gray-900 dark:text-white text-3xl font-black tracking-tight mt-1 truncate">Jazz Fusion</p></div>
                                    </div>
                                </div>
                            </div>
                        </div>
