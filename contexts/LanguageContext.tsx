...
const translations = {
  en: {
    ...
    'ranking.subtitle': 'Your albums sorted by musical taste',
    'ranking.no_ratings': "You haven't rated any albums yet",
    'ranking.start_rating': 'Start rating albums to see your ranking!',
    'ranking.personal_rating': 'Musical Taste',
    'ranking.artistic_rating': 'Artistic Value',
    'ranking.position': 'Position',
    'ranking.login_required': 'Log in to see your ranking',
    'ranking.login_desc': 'You need an account to save and view your ratings',
    ...
    'profile.close': 'Close',
    'profile.share_message': 'Join me on Album Del Día! Discover a new legendary album every day and build your musical journey. Check out my profile: ',
    'profile.share_prompt': 'Check out my profile on Album Del Día!',
    ...
    'comments.view_replies': 'View {count} replies',
    'comments.hide_replies': 'Hide replies',
    'comments.replying_to': 'Replying to {username}',
    ...
    'share.title': 'Share Stats',
    'share.button_share': 'Share',
    'profile.share': 'Share',
    'share.button_download': 'Download',
    'home.seo_title': 'Discover the Album of the Day',
    'home.seo_p1': 'Welcome to Albumdeldia, your definitive platform to explore the vast musical universe, one day at a time. Our mission is simple but powerful: break analysis paralysis and offer you a curated daily recommendation that allows you to discover hidden gems, timeless classics, and new releases from all genres.',
    'home.seo_p2': 'In a world saturated with options, we help you focus on what really matters: the music. Join our vibrant community of enthusiasts where you can keep a detailed record of your musical journey, rate albums, and share your honest opinions.',
    'home.seo_why': 'Why use Albumdeldia?',
    'home.seo_li1': 'Daily Discovery: Every 24 hours, a new carefully selected album appears on your front page.',
  ...
  es: {
    ...
    // Ranking
    'ranking.title': 'Mi Ranking',
    'ranking.subtitle': 'Tus álbumes ordenados por gusto musical',
    'ranking.no_ratings': 'Aún no has valorado ningún álbum',
    'ranking.start_rating': '¡Empieza a valorar álbumes para ver tu ranking!',
    'ranking.personal_rating': 'Gusto Musical',
    'ranking.artistic_rating': 'Valor Artístico',
    'ranking.position': 'Posición',
    'ranking.login_required': 'Inicia sesión para ver tu ranking',
    'ranking.login_desc': 'Necesitas una cuenta para guardar y visualizar tus valoraciones',
    ...
    'nav.ranking': 'Mi Ranking',

    // Library (Saved Albums)
    'library.title': 'Tu Colección',
    ...
    'profile.share_message': '¡Únete a mí en Album Del Día! Descubre un nuevo álbum legendario cada día y construye tu viaje musical. Echa un vistazo a mi perfil: ',
    'profile.share_prompt': '¡Mira mi perfil en Album Del Día!',
    ...
    'comments.view_replies': 'Ver {count} respuestas',
    'comments.hide_replies': 'Ocultar respuestas',
    'comments.replying_to': 'Respondiendo a {username}',
    ...
    'share.title': 'Compartir Estadísticas',
    'share.button_share': 'Compartir',
    'profile.share': 'Compartir',
    'share.button_download': 'Descargar',
    'home.seo_title': 'Descubre el Álbum del Día',
    'home.seo_p1': 'Bienvenido a Albumdeldia, tu plataforma definitiva para explorar el vasto universo musical, un día a la vez. Nuestra misión es simple pero poderosa: romper con la parálisis por análisis y ofrecerte una recomendación curada diariamente que te permita descubrir joyas ocultas, clásicos atemporales y nuevos lanzamientos de todos los géneros.',
    'home.seo_p2': 'En un mundo saturado de opciones, te ayudamos a concentrarte en lo que realmente importa: la música. Únete a nuestra vibrante comunidad de entusiastas donde podrás llevar un registro detallado de tu viaje musical, calificar álbumes y compartir tus opiniones honestas.',
    'home.seo_why': '¿Por qué usar Albumdeldia?',
    'home.seo_li1': 'Descubrimiento Diario: Cada 24 horas, un nuevo álbum seleccionado cuidadosamente aparece en tu portada.',
